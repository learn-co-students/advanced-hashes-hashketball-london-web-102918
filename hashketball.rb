...
def team_names
  team_name_arr = []
  game_hash.each do |location, team_data|
       team_name_arr.push(team_data[:team_name])
  end
  return team_name_arr
end
...
def player_numbers(team_name)
  ...
  game_hash.each do |location, team_data|
    if team_name == team_data[:team_name]
      team_data[:players].each do |player_key, stats_val|
          team_shirt_no.push(stats_val[:number])
      end
    end
  end
  return team_shirt_no
end    
